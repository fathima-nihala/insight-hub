        ...
        <nav className="flex items-center justify-between px-4 py-2 bg-white shadow-md w-full">
            ...
            <div className="flex justify-center items-center">
                <div className="relative ">
                    <input type="text" placeholder="Search here..." className="w-[500px] pl-10 pr-4 py-2 rounded-md  bg-[#F9FAFB] focus:outline-none focus:border-blue-500"  onChange={handleSearchChange} />
